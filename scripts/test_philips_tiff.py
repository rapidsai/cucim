...
def download_test_data():
    ...
    print("=" * 70)
    print("Source: https://openslide.cs.cmu.edu/download/openslide-testdata/Philips-TIFF/")
    print()
    
    test_files = [
        ("Philips-1.tiff", "311 MB", "Lymph node, H&E, BigTIFF, barcode (CAMELYON16)"),
        ("Philips-2.tiff", "872 MB", "Lymph node, H&E, BigTIFF, macro image (CAMELYON16)"),
        ("Philips-3.tiff", "3.08 GB", "Lymph node, H&E, BigTIFF, full metadata (CAMELYON16)"),
    ...
    print("\n💡 To download:")
    print("   wget https://openslide.cs.cmu.edu/download/openslide-testdata/Philips-TIFF/<filename>")
    print("\n📖 Format details:")
