 ...
 * on the actual histogram sizes:
 *
 *   __device__ void histogramMedianParCoarseLookupOnly(HIST_INT_T*, HIST_INT_T*, const int, int*, int*); 
 *   __device__ void histogramMedianParFineLookupOnly(HIST_INT_T*, HIST_INT_T*, const int, int*, int*);
 *
 */
