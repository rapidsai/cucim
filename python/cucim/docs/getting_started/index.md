...
Please download the latest SDK package (`cuCIM-v22.04.00-linux.tar.gz`).

Untar the downloaded file.

```bash
mkdir -p cuCIM-v22.04.00
tar -xzvf cuCIM-v22.04.00-linux.tar.gz -C cuCIM-v22.04.00
...
[Plugin: cucim.kit.cuslide] Loading the dynamic library from: cucim.kit.cuslide@22.04.00.so
