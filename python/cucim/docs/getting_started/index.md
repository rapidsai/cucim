...
Please download the latest SDK package (`cuCIM-v23.02.00-linux.tar.gz`).

Untar the downloaded file.

```bash
mkdir -p cuCIM-v23.02.00
tar -xzvf cuCIM-v23.02.00-linux.tar.gz -C cuCIM-v23.02.00
...
[Plugin: cucim.kit.cuslide] Loading the dynamic library from: cucim.kit.cuslide@23.02.00.so
