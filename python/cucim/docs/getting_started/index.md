...
Please download the latest SDK package (`cuCIM-v21.10.00-linux.tar.gz`).

Untar the downloaded file.

```bash
mkdir -p cuCIM-v21.10.00
tar -xzvf cuCIM-v21.10.00-linux.tar.gz -C cuCIM-v21.10.00
...
[Plugin: cucim.kit.cuslide] Loading the dynamic library from: cucim.kit.cuslide@21.10.00.so
